    ...
    methods
        function obj = plnet(layerSizes, initialWeightRange)
            if nargin == 0
                ...
                %rng(15)
                obj.initialWeightRange = initialWeightRange;
...
%             end
        ...
        function [activations, zs, utility] = feedforward(obj, input)
            ...
            a = double(input'); % fix 2018-01-20, ensure that dot product below (obj.weights{1,i2}*a) can be calculated           
            activations{1} = a;
        ...
        function new = copy(this)
            ...
            new = plnet(this.layerSizes, this.initialWeightRange);
